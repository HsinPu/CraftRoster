...
const OUTPUT = path.join(__dirname, 'codex-tool-surface-probe-v4.json');
...
async function main() {
  ...
  const report = {
    ...
    source_version: 2,
    previous_probe: { report: 'codex-tool-surface-probe.json', harness_sha256: 'd87b5d93c1d5152e696913cc52f72d3c99a72e8d2e0bd91e25f3814278f9fbac',
      outcome: 'Historical v1 had zero requests and exit 1. Its original harness hash remains historical; current source adds bounded config-startup diagnostics.' },
    ...
    documentation_checked: ['https://learn.chatgpt.com/docs/config-file/config-advanced', 'https://learn.chatgpt.com/docs/config-file/config-reference'],
